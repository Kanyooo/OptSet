...
def main() -> None:
    out = Path("./datasets")
    args_gen = type("Args", (), {"suite": "core18", "scales": "S", "problems": "A1_QP,A4_ECQP,B1_LASSO,D2_BP,C2_LCP", "out": str(out), "seed": 42, "extreme": False})
    ...
    args_report = type("Args", (), {"root": str(out / "core18_S"), "save_md": "./reports/summary.md", "save_csv": "./reports/summary.csv"})
